...
function Allproductsordersadmin() {
          ...
          Object.keys(userOrders).forEach(orderId => {
            if (userOrders[orderId] && typeof userOrders[orderId] === 'object') {
              ...
              const metadataFields = ['address', 'phno', 'username', 'orderTimestamp', 
                                   'orderTotal', 'odered', 'delivered', 'notes'];
                ...
                {order.products.map((product, index) => (
                  <div key={index} className="product-item">
                    <div className="product-image">
                      <img src={getImageFilename(product.productimage)} alt={product.productname}  onError={(e) => {
...
export default Allproductsordersadmin;